...
import ArticleForm from './ArticleForm' // Убедитесь, что этот импорт присутствует
...
export default function ArticleList() {
  ...
  const handleArticleCreate = (newArticle: Article) => {
    ...
    // Optionally, you might want to select the newly created article
  ...
  return (
    <div className="space-y-6">
      <div className="bg-white rounded-lg shadow p-6"> {/* Обертка для формы создания */}
        <ArticleForm onSubmit={handleArticleCreate} />
      </div>
